        ...
        <section class="col-12">
            <form id="createUserForm" class="animate_label" method="post" enctype="application/x-www-form-urlencoded">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 form-input">
                        <label class="col-md-12 col-form-label" for="user_age">Age:</label>
                ...
                <div class="form-group row">
                    <div class="col-sm-6 col-sm-offset-3 form-input">
                        <label class="col-md-12 col-form-label" for="emailaddr">Email Address:</label>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6 form-input">
                        <label class="col-md-12 col-form-label" for="password2">Confirm Password:</label>
